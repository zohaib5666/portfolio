...
},
{
  ...
  // CONTACT INFO
  contact: [
    { icon: "📍", label: "Location",  value: "Lahore, Punjab, Pakistan",        link: null },
    { icon: "✉️", label: "Email",     value: "zohaibusmanlive@gmail.com",            link: "mailto:zohaibusmanlive@gmail.com" },
    { icon: "📞", label: "Phone",     value: "+92 304 5666900",                  link: "tel:+923045666900" },
    { icon: "💼", label: "LinkedIn",  value: "linkedin.com/in/muhammad-zohaib-usman-916b60125",     link: "https://www.linkedin.com/in/muhammad-zohaib-usman-916b60125" },
  
    { icon: "🐙", label: "GitHub",    value: "github.com/zohaib5666",          link: "https://www.github.com/zohaib5666" },
    { icon: "🌐", label: "Available", value: "Open to new opportunities",        link: null },
  ],
    ...
    ${portfolioData.contact.map(c => `
      <div class="contact-item">
        ...
        <div>
          ...
          ${c.link
            ? `<a href="${c.link}" target="_blank" rel="noopener noreferrer" class="contact-item-link">${c.value}</a>`
